...
#--------FUNCTIONS--------------------------------------------
def again():
    '''This function asks a user if they'd like to enter another temp, checks the response for validity, and then returns a valid response back to main program'''
...
def converter(f):
    '''This function is passed a tempF value ('f' parameter), converts to celsius, and returns the tempC value'''
...
while answer == "y":
    ...
    answer = again() 
    #the return value of this function will replace this call as final result for 'answer'
